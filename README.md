...
curl -s https://raw.githubusercontent.com/ntt2125/docker-magento/master/lib/onelinesetup | bash -s -- magento.test 2.4.6-p2 community
```
...
# Download the Docker Compose template:
curl -s https://raw.githubusercontent.com/ntt2125/docker-magento/master/lib/template | bash
